...
| HOME-08 | Assistant Coach | Saknas som motsvarande gammal funktion | **Nytt** | AC blir senare assistent ovanpå stabila event-, trupp-, callup- och närvarosignaler. | Endast lokal prototyp | Godkänd |
| HOME-09 | AC som flytande knapp på mobil | Saknas | **Nytt** | FAB nere till höger på mobil; tablet/desktop får integrerad panel där utrymme finns. | Ej produktionsklar | Godkänd |
