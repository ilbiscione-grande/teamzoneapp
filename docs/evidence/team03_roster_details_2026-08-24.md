...
- Migrationen är skapad lokalt men har inte körts mot Supabase live.
- SQL-runtime kan inte köras lokalt eftersom Docker/PostgreSQL saknas i miljön.
- Fysisk verifiering av mobil bottom sheet och tablet/desktop tvåpanelsvy återstår.
