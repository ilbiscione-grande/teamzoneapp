-- Keep archived roster rows inspectable while preventing them from being edited.
...
values('20260902043444_team04_archived_person_details','greenfield','TEAM-04 archived roster rows remain readable but immutable');
