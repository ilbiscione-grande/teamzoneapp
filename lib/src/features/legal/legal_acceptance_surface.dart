...
// The marketing preference toggle used to be its own bottom sheet, opened
// straight from the drawer's "Inställningar" row. It's now one section of
// the full _ProfileSettingsSurface page (features/account/
// profile_settings_surface.dart), alongside team connections management.
